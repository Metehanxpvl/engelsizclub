...
''';
  ...
  test('news maps onto Fırsatlar Haber chip without a new screen', () {
    ...
    expect(kUsefulContentCategories['kuresel'], 'Küresel haber');
    expect(usefulCategoryFromGlobalNews('erisilebilirlik'), 'kuresel');
    expect(usefulCategoryFromGlobalNews('haklar'), 'kuresel');
    ...
    expect(item.category, 'kuresel');
    expect(item.categoryLabel, 'Küresel haber');
