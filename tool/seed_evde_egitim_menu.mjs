/** Insert Evde Eğitim URL into daha_fazlasi_menu. Do not print secrets. */
...
const res = await fetch(
  `${url}/rest/v1/daha_fazlasi_menu?or=(title.ilike.Evde%20E%C4%9Fitim,link.ilike.*evde-egitim*)&select=id,title,link,link_type,is_active,sort_order`,
  { headers },
);
